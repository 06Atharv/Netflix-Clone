        ...
        <>
            <div className={SignInCss['signin-ui']}>
                ...
                <div className={`w-[30em] p-16 pt-10 place-self-center block justify-center mt-[1em] text-white ${SignInCss['sigin-panel-div']}`}>
                    <h4>Sign In</h4>
                    <input type='text' placeholder='Email or Mobile Number' ref={username} className={`${SignInCss['email-pass-ip']} block w-full mt-[2em] h-[3.4em] p-3`} />
                    <input id='passInputField' type='password' placeholder='Password' ref={password} className={`${SignInCss['email-pass-ip']} block w-full mt-[1em] h-[3.4em] p-3`} />
